...
[**ClassList**](annotated.md) **>** [**muda**](namespacemuda.md) **>** [**TripletMatrixViewer**](classmuda_1_1_triplet_matrix_viewer.md)
...
| Type | Name |
| ---: | :--- |
| typedef typename Base::BlockMatrix | [**BlockMatrix**](#typedef-blockmatrix)  <br> |
| typedef typename Base::CTriplet | [**CTriplet**](#typedef-ctriplet)  <br> |
| typedef [**CTripletMatrixViewer**](classmuda_1_1_c_triplet_matrix_viewer.md)&lt; T, N &gt; | [**ConstViewer**](#typedef-constviewer)  <br> |
| typedef [**TripletMatrixViewer**](classmuda_1_1_triplet_matrix_viewer.md)&lt; T, N &gt; | [**NonConstViewer**](#typedef-nonconstviewer)  <br> |
...
|  MUDA\_GENERIC [**Proxy**](classmuda_1_1_triplet_matrix_viewer_1_1_proxy.md) | [**operator()**](#function-operator()) (int i) <br> |
