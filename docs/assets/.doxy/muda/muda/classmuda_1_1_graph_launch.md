...
# Class muda::GraphLaunch



[**ClassList**](annotated.md) **>** [**muda**](namespacemuda.md) **>** [**GraphLaunch**](classmuda_1_1_graph_launch.md)
...
| Type | Name |
| ---: | :--- |
|   | [**GraphLaunch**](#function-graphlaunch) (cudaStream\_t stream=nullptr) <br> |
|  [**GraphLaunch**](classmuda_1_1_graph_launch.md) & | [**launch**](#function-launch) (const [**GraphViewer**](classmuda_1_1_graph_viewer.md) & graph) <br> |
|   | [**~GraphLaunch**](#function-graphlaunch) () = default<br> |
...
```C++
inline muda::GraphLaunch::GraphLaunch (
...
```C++
GraphLaunch & muda::GraphLaunch::launch (
...
```C++
muda::GraphLaunch::~GraphLaunch () = default
```
